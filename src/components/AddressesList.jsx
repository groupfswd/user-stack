...
export default function AddressesList() {
  ...
  return (
    <div>
          ...
          {isFormVisible && (
            <form onSubmit={handleAddAddress} className="flex flex-col">
              ...
              <div className="flex justify-center">
                <button type="submit" className="w-1/5 btn btn-success mr-5">
                  Add New Address
                </button>
                <button onClick={toggleForm} className=" w-1/5 btn btn-error">
                  Cancel
                </button>
              </div>
            </form>
      ...
      {addresses.sort((a, b) => a.id - b.id).map((address, index) => (
          <div className="text-center pb-10" key={index}>
            ...
            <button
              className="w-24 btn btn-success mr-5 mt-3"
              onClick={() => toggleEditForm(index)}
            >
              Edit
            </button>
            <button
              className="w-24 btn btn-error"
